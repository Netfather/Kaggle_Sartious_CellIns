...
SCORE_THRESHOLDS = [0.15,0.30,0.60]
MIN_PIXELS = [30, 60, 30]
matrix = [[],[],[],[],[]]
matrix_fold_id = 0
...
class Trainer(DefaultTrainer):
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        return COCOEvaluator(dataset_name, cfg = cfg, distributed = True, output_dir = output_folder,TOPK_TYPE= 'default')
...
def setup(args,fold_id):
    ...
    cfg.OUTPUT_DIR  ="/storage/Kaggle_Cell_Segmentation/model/MaskRNN/Res50_Semi_Version4"
    ...
    cfg.MODEL.WEIGHTS = '/storage/Kaggle_Cell_Segmentation/model/MaskRNN/Res50Pretrained_Version3/model_best_fold1.pth'
