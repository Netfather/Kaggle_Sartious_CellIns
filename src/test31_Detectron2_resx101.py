...
#         11. 修正 TOPK的容量， livecell数据集中的容量 和比赛的数据容量并不匹配
...
def setup(args,fold_id):
    ...
    cfg.OUTPUT_DIR  ="/storage/Kaggle_Cell_Segmentation/model/MaskRNN/test31"
    os.makedirs(cfg.OUTPUT_DIR, exist_ok=True)
    cfg.INPUT.MASK_FORMAT='bitmask'
    register_coco_instances('sartorius_train{}'.format(fold_id),{}, '../data/2022_bie_split_train_fold{}.json'.format(fold_id), dataDir)
    register_coco_instances('sartorius_val{}'.format(fold_id),{},'../data/2022_bie_split_val_fold{}.json'.format(fold_id), dataDir)
