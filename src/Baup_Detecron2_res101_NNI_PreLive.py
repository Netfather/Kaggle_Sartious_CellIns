...
def Train_Per_Fold(fold_id,args):
    ...
    cfg.MODEL.WEIGHTS = '/storage/Kaggle_Cell_Segmentation/model/MaskRNN/R101Pretrained/model_best_fold1.pth'  # Let training initialize from the pretrained model
