...
# 此模型为 在 LIVECELL 全上 以 6batch 跑了 20000个 ite之后 作为初始化  然后开始测试的结果
import os
...
class Trainer(DefaultTrainer):
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        return COCOEvaluator(dataset_name,distributed= True)
...
def setup(args,fold_id):
    ...
    cfg.OUTPUT_DIR  ="/storage/Kaggle_Cell_Segmentation/model/MaskRNN/test18"
