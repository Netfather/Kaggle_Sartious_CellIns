...
def setup(args,fold_id):
    ...
    cfg.OUTPUT_DIR  ="/storage/Kaggle_Cell_Segmentation/model/MaskRNN/Res50Pretrained_Version6"
    ...
    # MODEL
    cfg.MODEL.WEIGHTS =  "/storage/Kaggle_Cell_Segmentation/model/model_final_GN.pkl"  # Let training initialize from model zoo
    ######################################################################################################################################################
