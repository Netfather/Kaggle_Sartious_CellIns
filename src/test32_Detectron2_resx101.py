...
#         8. 根据 test30的结果，经过验证，表明不同的backbone 应该使用不同的 置信分数阈值，特别是当resx101还修改了默认的结果的时候
...
def setup(args,fold_id):
    ...
    cfg.OUTPUT_DIR  ="/storage/Kaggle_Cell_Segmentation/model/MaskRNN/test32"
    ...
    # cfg.MODEL.WEIGHTS = '/storage/Kaggle_Cell_Segmentation/model/MaskRNN/test30/model_best_fold1.pth'  # Let training initialize from the pretrained model
