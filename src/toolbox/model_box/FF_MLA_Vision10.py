...
class MLA(nn.Module):
    def __init__(self,w:int,  h:int,   patch_size:int,  depth = 4,  emb_dim = 37 * 37,drop_rate = 0.1):
...
class UNet(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=True,transformer_drop_rate = 0.1):
        ...
        self.mla = MLA(74,74,74,1,emb_dim= 74*74,drop_rate= transformer_drop_rate)
...
if __name__ == '__main__':
    ...
    input_data = torch.randn(size=[2,1,320,240])
