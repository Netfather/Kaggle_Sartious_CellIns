# -*- coding: utf-8 -*-#
# -------------------------------------------------------------------------------
# Name:         Feature_Fusion_Vision4
# Description:  特征融合模块的第4个实验，取消 自注意力机制 分支 查看结果
...
class FeatureFusionModule(nn.Module):
    def __init__(self,nin:int,nout:int):
        ...
        self.conv1_1 = kernel_1_1_conv_bn_relu( nin,nin )
        #self.cbam =  SCSEModule(in_channels= nin,reduction= 4)
        self.depthwiseconv3_3 = depthwise_separable_conv(nin,nin )
